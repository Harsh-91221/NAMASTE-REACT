...
const resObj = [
    ...
    },
    {
        "info": {
            "id": "28798",
            "name": "Domino's Pizza",
            "cloudinaryImageId": "eqhgr7go78dprubzl7f0",
            "locality": "Alpha 1",
        ...
        "cta": {
            "link": "https://www.swiggy.com/restaurants/dominos-pizza-alpha-1-greater-noida-noida-1-28798",
            "type": "WEBLINK"
        }
    },
    {
    ...
    },
    {
        "info": {
            ...
            "availability": {
                "nextCloseTime": "2024-01-22 20:30:00",
                "opened": true
            },
            "badges": {
    ...
    },
    {
        ...
        "cta": {
            "link": "https://www.swiggy.com/restaurants/the-brooklyn-creamery-healthy-ice-cream-phi-3-greater-noida-noida-1-381720",
            "type": "WEBLINK"
        }
    },
    {
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                {
                    resObj.map((resturant) => (<ResturantCard key={resturant.info.id} resData={resturant} />))
                }
            </div>
        </div>
    );
